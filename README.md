...
Install the `agent` CLI (https://platform.tradexpress.co/docs/en/cli-sdks-libraries/cli/Quickstart/Preview), preview the plan, then apply it (https://web.tradexpress.co/docs/en/cli-sdks-libraries/cli/scripting#version-controlling-api-resources):
